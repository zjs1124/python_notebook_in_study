...
class CarSpider(scrapy.Spider):
    ...
    start_urls = ["https://www.che168.com/nanjing/a0_0msdgscncgpi1ltocsp1exf4/?pvareaid=102179"]
    current_page = 1
    end_page = 17
    custom_settings = {
    ...
    def start_requests(self):
        url = "https://www.che168.com/nanjing/a0_0msdgscncgpi1ltocsp1exf4/?pvareaid=102179"
        headers = {
    ...
    def parse(self, response):
        ...
        if self.current_page < self.end_page:
            ...
            next_url = f"https://www.che168.com/nanjing/a0_0msdgscncgpi1ltocsp{next_page}exf4/?pvareaid=102179"
            self.current_page += 1
